...
def checkHitBall(ball, paddle1, paddle2, ballDirX):
    global YBALLSPEED, XBALLSPEED, NUMHITS
    ...
    if ballDirX == -1 and paddle1.colliderect(ball):
        NUMHITS += 1
        pong_sound()
        # if ball.bottom <= paddle1.top + 15 or paddle1.bottom - 15 <= ball.top:
        #     YBALLSPEED = 2
        #     XBALLSPEED = 2
        # else:
        #     YBALLSPEED = 1
        ...
        NUMHITS += 1
        pong_sound()
        # if ball.bottom <= paddle2.top + 15 or paddle2.bottom - 15 <= ball.top:
        #     YBALLSPEED = 2
        #     XBALLSPEED = 2
        # else:
        #     YBALLSPEED = 1
...
def displayScore(score):
    resultSurf = BASICFONT.render('NUMHITS = %s' %NUMHITS, True, WHITE)
